...
CATEGORY_KEYWORDS = [
    ("Food & Drink", [
        ...
        "steak dinner", "bar", "mezcal", "tequila", "taco tour", "mercado",
    ]),
    ("Music", [
    ...
    ("Arts & Theatre", [
        ...
        "teatro", "obra", "monólogo", "stand up", "improvisación",
    ]),
    ("Sports & Fitness", [
        ...
        "futbol", "fútbol", "ciclismo", "senderismo", "escalada",
    ]),
    ("Nightlife", [
        ...
        "antro", "discoteca", "barra", "cantina", "mezcalería",
    ]),
    ("Food & Drink", [
        "taco", "taquería", "tortilla", "quesadilla", "tostada", "tamal",
        "pozole", "menudo", "birria", "carnitas", "al pastor", "chorizo",
        "chilaquiles", "enchilada", "mole", "salsa", "guacamole", "ceviche",
        "aguachile", "tostada", "gordita", "sope", "huarache", "tlacoyo",
    ]),
    ("Family & Kids", [
    ...
    ("Tech & Business", [
        ...
        "emprendimiento", "networking", "conferencia", "taller",
    ]),
    ("Health & Wellness", [
    ...
    ("Community & Social", [
        ...
        "voluntariado", "beneficencia", "recaudación",
    ]),
]
...
def map_row(row):
    ...
    return {
        ...
        "start_time": to_mexico_city_iso(start_dt),
        "end_time": to_mexico_city_iso(end_dt),
        "city": "Mexico City",
